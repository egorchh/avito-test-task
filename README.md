...
- Для тестирования комментариев, пожалуйста, выбирайте самые популярные (залайканые) новости. На многих новостях из списка "новых" комментарии, попросту, не успели появиться
